...
public class AlertMsg extends AbstractModel {
	
	public static final String TABLE_NAME = "alertmsg";
	...
	/*
		params: database, alertId, startTime, endTime, status, orderBy
	 */
	public static Cursor list(SQLiteDatabase db, String... args) {
		String[] columns = {COL_ID, COL_ALERTID, COL_DATETIME, COL_STATUS};
